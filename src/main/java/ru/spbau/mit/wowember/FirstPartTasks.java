...
public final class FirstPartTasks {
    ...
    // Сгруппировать альбомы по артистам (в качестве значения вместо объекта 'ru.spbau.mit.wowember.Artist' использовать его имя)
    ...
    public static int moduloProduction(IntStream stream, int modulo) {
        return stream.reduce(1, (s, x) -> (s * x) % modulo);
    }
