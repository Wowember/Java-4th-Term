...
public class TorrentClientFrame extends JFrame {
    ...
    private class TorrentTableModel extends AbstractTableModel {
        ...
        public Object getValueAt(int rowIndex, int columnIndex) {
            ...
            switch (columnIndex) {
                case 0:
                    return client.getFilesInfo().get(rowIndex).getFileName();
                case 1:
                    return client.getFilesInfo().get(rowIndex).getFileSize();
                case 2:
                    return client.getFilesInfo().get(rowIndex).getDownloadedPercentage();
                default:
                    return null;
            }
        }
    ...
    TorrentClientFrame() throws IOException {
        ...
        client = new TorrentClient(Paths.get("C:\\Users\\Wowember\\Desktop"), "");
    ...
    private class GetFilesTableModel extends AbstractTableModel {
        ...
        public Object getValueAt(int rowIndex, int columnIndex) {
            ...
            switch (columnIndex) {
                case 0:
                    return files.get(rowIndex).getFileName();
                case 1:
